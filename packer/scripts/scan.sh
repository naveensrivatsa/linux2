...
sudo oscap xccdf eval --fetch-remote-resources --profile xccdf_org.ssgproject.content_profile_pci-dss --results-arf /var/tmp/roles/security/output/arf-pci-dss.xml --report /var/tmp/roles/security/report-pci-dss.html /usr/share/xml/scap/ssg/content/ssg-amzn2-ds.xml
